...
export default function Sidebar({ activePage, setActivePage, theme, toggleTheme, metrics }) {
  const navItems = [
  ...
  return (
    <aside className="w-64 flex-shrink-0 bg-neo-bg dark:bg-neo-darkBg border-r-2 border-neo-black dark:border-white/80 flex flex-col justify-between p-4 h-screen sticky top-0 transition-colors">
      <div>
        {/* Neobrutalism App Brand Header */}
        <div className="flex items-center gap-3 p-3 mb-6 bg-neo-yellow text-neo-black border-2 border-neo-black rounded-2xl shadow-neo">
